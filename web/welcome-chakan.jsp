...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!--体 -->
            <div class="modal-body">
                <form action="<%=request.getContextPath()%>/addSP" method="post">
                    <div class="form-group">
                        <label for="brand">id</label>
...
<div class="myposition" style="top: 30px;">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <%--<td><button type="button" class="btn btn-danger"data-toggle="modal" data-target="#delModal">
                <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>删除
            </button></td>--%>
            ...
            <td><%=m.getCapacity()%></td>
            <td><%=m.getCoding()%></td>
            <td><%=m.getRepertory()%></td>
               <%-- <td>
                    <a href ="<%=request.getContextPath()%>/delete1?id=<%=m.getId()%>">删除</a>
                </td>--%>
                <td><input type="button" name="delete" value="删除" onclick="checkAllBox()"formmethod="post"></td>
        </tr>
        <script type="text/javascript">
            function checkAllBox() {
                ...
                for(var i = 0;i < answer.length;i++)
                {
                    if (answer[i].checked == true) {
                        location.href = "<%=request.getContextPath()%>/delete1?id=<%=m.getId()%>"
                    }
                }
            }
        </script>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" onclick="delete1()">确认</button>
                        </div>
                    </div>
                </div>
            </div>--%>
